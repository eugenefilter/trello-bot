...
return [
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Секретный токен, который Telegram отправляет в заголовке
    | X-Telegram-Bot-Api-Secret-Token для верификации запросов.
    | Задаётся при регистрации webhook через setWebhook API.
    |
    */
